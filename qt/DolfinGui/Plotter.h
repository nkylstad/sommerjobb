...
#include <dolfin/plot/VTKPlottableCSGGeometry.h>
...
class PlotterDecorators : public QObject
{
    Q_OBJECT
...
public slots:
    ...
    void static_plot(Plotter *p, const boost::shared_ptr<dolfin::Variable> obj)
    { p->plot(obj); }
